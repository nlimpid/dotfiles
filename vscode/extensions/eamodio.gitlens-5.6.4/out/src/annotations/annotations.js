...
class Annotations {
    ...
    static getHoverCommandBar(commit, hasRemotes, annotationType) {
    ...
    static getHoverMessage(commit, dateFormat, hasRemotes, annotationType) {
        if (dateFormat === null) {
...
\`\`\``;
    ...
    static changesHover(commit, line, uri, git) {
        return __awaiter(this, void 0, void 0, function* () {
            const chunkLine = yield git.getDiffForLine(uri, line, commit.isUncommitted ? undefined : commit.previousSha);
    ...
    static detailsHover(commit, dateFormat, hasRemotes, annotationType) {
