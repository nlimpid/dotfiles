...
class GitCodeLensProvider {
    ...
    _resolveGitRecentChangeCodeLens(lens, token) {
        ...
        switch (this._config.codeLens.recentChange.command) {
            ...
            case configuration_1.CodeLensCommand.ShowQuickCurrentBranchHistory: return this._applyShowQuickCurrentBranchHistoryCommand(title, lens, blame, recentCommit);
            ...
            case configuration_1.CodeLensCommand.ToggleFileBlame: return this._applyToggleFileBlameCommand(title, lens, blame);
            default: return lens;
        }
    }
    _resolveGitAuthorsCodeLens(lens, token) {
        ...
        switch (this._config.codeLens.authors.command) {
            ...
            case configuration_1.CodeLensCommand.ShowQuickCurrentBranchHistory: return this._applyShowQuickCurrentBranchHistoryCommand(title, lens, blame);
    ...
    _applyShowQuickCurrentBranchHistoryCommand(title, lens, blame, commit) {
        lens.command = {
            title: title,
    ...
    _applyToggleFileBlameCommand(title, lens, blame) {
        lens.command = {
            title: title,
