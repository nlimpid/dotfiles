    ...
    constructor(remotes, resource, goBackCommand) {
        ...
        switch (resource.type) {
            case gitService_1.RemoteResourceType.Branch:
                ...
                break;
            case gitService_1.RemoteResourceType.Branches:
                description = `$(git-branch) Branches`;
                break;
            case gitService_1.RemoteResourceType.Commit:
                const shortSha = gitService_1.GitService.shortenSha(resource.sha);
            ...
            case gitService_1.RemoteResourceType.File:
                ...
                break;
            case gitService_1.RemoteResourceType.Repo:
            ...
            case gitService_1.RemoteResourceType.Revision:
                if (resource.commit !== undefined && resource.commit instanceof gitService_1.GitLogCommit) {
                    ...
                    const shortFileSha = resource.sha === undefined ? '' : gitService_1.GitService.shortenSha(resource.sha);
