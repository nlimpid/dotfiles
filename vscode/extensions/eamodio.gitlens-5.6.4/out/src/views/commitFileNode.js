...
class CommitFileNode extends explorerNode_1.ExplorerNode {
    constructor(status, commit, context, git, displayAs = CommitFileNodeDisplayAs.Commit, branch) {
        ...
        this.branch = branch;
        this.priority = false;
        this.resourceType = 'gitlens:commit-file';
    ...
    getTreeItem() {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.commit.type !== gitService_1.GitCommitType.File) {
                const log = yield this.git.getLogForFile(this.repoPath, this.status.fileName, this.commit.sha, { maxCount: 2 });
                if (log !== undefined) {
