        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.status.files.length !== 0 && this.includeWorkingTree) {
                statuses.splice(0, 0, ...this.status.files.map(s => {
                    return Object.assign({}, s, { commit: new gitService_1.GitLogCommit(gitService_1.GitCommitType.File, repoPath, gitService_1.GitService.uncommittedSha, s.fileName, 'You', new Date(), '', s.status, [s], s.originalFileName, 'HEAD', s.fileName) });
                }));
            }
