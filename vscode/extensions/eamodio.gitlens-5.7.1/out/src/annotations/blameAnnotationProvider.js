...
class BlameAnnotationProviderBase extends annotationProvider_1.AnnotationProviderBase {
    ...
    selection(shaOrLine, blame) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const highlightDecorationRanges = blame.lines
                .filter(l => l.sha === sha)
                .map(l => this.editor.document.validateRange(new vscode_1.Range(l.line, 0, l.line, 1000000)));
    ...
    provideDetailsHover(document, position, token) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const message = annotations_1.Annotations.getHoverMessage(logCommit || commit, this._config.defaultDateFormat, this.git.hasRemotes(commit.repoPath), this._config.blame.file.annotationType);
