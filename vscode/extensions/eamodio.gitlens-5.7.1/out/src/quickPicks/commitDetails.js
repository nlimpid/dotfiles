...
class CommitWithFileStatusQuickPickItem extends common_1.OpenFileCommandQuickPickItem {
    constructor(commit, status) {
        ...
        super(gitService_1.GitService.toGitContentUri(sha, status.fileName, commit.repoPath, status.originalFileName), {
        ...
        this.sha = sha;
        this.shortSha = gitService_1.GitService.shortenSha(sha);
...
class OpenCommitFileRevisionsCommandQuickPickItem extends common_1.OpenFilesCommandQuickPickItem {
    constructor(commit, item) {
        const uris = commit.fileStatuses
            .filter(s => s.status !== 'D')
            .map(s => gitService_1.GitService.toGitContentUri(commit.sha, s.fileName, commit.repoPath, s.originalFileName));
        super(uris, item || {
