...
class RemoteNode extends explorerNode_1.ExplorerNode {
    constructor(remote, uri, context, git) {
        super(uri);
        this.remote = remote;
        this.context = context;
        this.git = git;
        this.resourceType = 'gitlens:remote';
    }
    getChildren() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return [...system_1.Iterables.filterMap(branches, b => !b.remote || !b.name.startsWith(this.remote.name) ? undefined : new branchHistoryNode_1.BranchHistoryNode(b, this.uri, this.context, this.git))];
        });
    }
    getTreeItem() {
        const fetch = this.remote.types.includes(gitService_1.GitRemoteType.Push);
        const push = this.remote.types.includes(gitService_1.GitRemoteType.Push);
        let separator;
        if (fetch && push) {
