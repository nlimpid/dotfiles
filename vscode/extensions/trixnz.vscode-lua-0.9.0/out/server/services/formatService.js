...
function buildDocumentFormatEdits(documentUri, document, extFormatOptions) {
    ...
    let formattedText = lua_fmt_1.formatText(documentText, formatOptions);
...
function buildDocumentRangeFormatEdits(_documentUri, _document, _range, _extFormatOptions) {
    return [];
}
