...
- This extension provides now a basic [Apiary](https://apiary.io) integration. See the [README](https://github.com/XVincentX/vscode-apielements/blob/master/./client/README.md) for more informations
...
- Clear all related annotations when a document is closed. See [https://code.visualstudio.com/updates#_extension-authoring](https://github.com/XVincentX/vscode-apielements/blob/master/VSCode updates) for more details.
